...
@Component
public class LkaMaClientCriteriasDaoSpringImpl implements LkaMaClientCriteriasDao {
    ...
    @Autowired
    public LkaMaClientCriteriasDaoSpringImpl(DataSource dataSource) {
        jdbcTemplate = new JdbcTemplate(dataSource);
    }

    private RowMapper<LkaMaClientCriterias> clientCriteriasRowMapper = (resultSet, i) -> {
        return new LkaMaClientCriterias(
    ...
    @Override
    public int save(LkaMaClientCriterias lkaMaClientCriterias) {
        return jdbcTemplate.execute(SQL_SAVE, new PreparedStatementCallback<Integer>() {
            ...
            public Integer doInPreparedStatement(PreparedStatement preparedStatement) throws SQLException, DataAccessException {
                fillStatement(preparedStatement, lkaMaClientCriterias);
    ...
    @Override
    public LkaMaClientCriterias find(int id) {
        throw new RuntimeException("This method not used");
    }

    @Override
    public List<LkaMaClientCriterias> findAll() {
        throw new RuntimeException("This method not used");
    }

    @Override
    public boolean update(LkaMaClientCriterias clientCriterias) {
    ...
    @Override
    public void remove(LkaMaClientCriterias lkaMaClientCriterias) {
        throw new RuntimeException("This method not used");
    }

    @Override
    public List<LkaMaClientCriterias> findAllByClientAndDates(int clientId, LocalDate startDate, LocalDate endDate) {
    ...
    private void fillStatement(PreparedStatement statement, LkaMaClientCriterias clientCriterias) throws SQLException {
