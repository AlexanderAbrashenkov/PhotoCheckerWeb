...
public class LkaCriteriaServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        lkaCriteriasService = (LkaCriteriasService) context.getBean("lkaDmpCriteriasService");
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("../WEB-INF/view/lkaDmp/lkaCriteriaPage.jsp");
