 ...
 */
@WebServlet(
        name = "downloadLkaDmpLkas",
        urlPatterns = "/reports/lkaDmp/getLkas"
)
public class DownloadLkaServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       List<Lka> lkaList = lkaService.getLkas(distrId, dateFrom, dateTo, 1);
        request.setAttribute("lkaList", lkaList);
        RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/view/lkaDmp/ajax_parts/lkaOptions.jsp");
