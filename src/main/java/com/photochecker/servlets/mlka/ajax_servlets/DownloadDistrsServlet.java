 ...
 */
@WebServlet(
        name = "downloadMlkaDistrs",
        urlPatterns = "/reports/mlka/getDistrs"
)
public class DownloadDistrsServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Distr> distrList = distrService.getDistrs(user, regionId, dateFrom, dateTo, 2, nkaId);
        request.setAttribute("distrList", distrList);
        RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/view/mlka/ajax_parts/distrOptions.jsp");
